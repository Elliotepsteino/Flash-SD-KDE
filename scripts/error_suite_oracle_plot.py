...
from experiments.error_suite_a100_16d.plotting import load_rows, plot_oracle_mise_miae_vs_n
...
def _latest_error_suite_results(repo_root: Path) -> Path | None:
    ...
    if not runs:
        print(f"No error_suite_a100_16d runs found under {base}; cannot plot oracle.")
        return None
    return runs[0]
...
def main() -> int:
    ...
    parser.add_argument("--results_dir", default=None, help="Optional error_suite_a100_16d run directory.")
