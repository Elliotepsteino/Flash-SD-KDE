...
$n_{\text{test}}=4\text{k}$.  The results are summarized in
Table~\ref{tab:pykeops} and show a $7\times$ speedup for fully debiased SD-KDE
even though PyKeOps evaluates only the KDE stage.
