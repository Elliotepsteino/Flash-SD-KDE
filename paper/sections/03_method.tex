...
\texttt{tl.dot} interface~\citep{tillet2019triton}.  The remaining operations---vector norms,
...
norms and exponentials.  In this paper we focus on the $d=16$ case, which
