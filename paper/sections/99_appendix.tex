...
\begin{figure}[t]
  \centering
  \includegraphics[width=0.8\linewidth]{figures/legacy/runtime_1d_kde_sdkde.pdf}
...
\begin{figure}[t]
  \centering
  \includegraphics[width=0.8\linewidth]{figures/legacy/util_1d_empirical_sdkde.pdf}
...
\begin{figure}[t]
  \centering
  \includegraphics[width=0.8\linewidth]{figures/legacy/util_1d_triton_scaling.pdf}
