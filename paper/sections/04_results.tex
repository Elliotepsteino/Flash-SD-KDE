...
Figure~\ref{fig:oracle_error_1d} compares KDE, Flash-SD-KDE (fused Laplace correction), non-fused Laplace correction, and Flash-SD-KDE.
...
\begin{figure*}[t]
  ...
  \caption{Oracle error on a 1D mixture-of-Gaussians benchmark.
          We report MISE and MIAE versus $n_{\text{train}}$ for KDE, Flash-SD-KDE (fused Laplace correction), non-fused Laplace correction, and Flash-SD-KDE.
...
\begin{figure*}[t]
  ...
  \caption{Runtime and speedup for Laplace correction in 1D.
          ...
          The right panel reports speedup ratios, including Flash-SD-KDE relative to Flash-SD-KDE for context.}
